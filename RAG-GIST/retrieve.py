...
from langchain_core.runnables import (
    RunnablePassthrough,
)  # to pass the context and question to the llm
from langchain_openai import (
    ChatOpenAI,
    OpenAIEmbeddings,
)  # to initialize the llm and embeddings
from langchain_pinecone import PineconeVectorStore  # to initialize the vector store
from langchain_core.prompts import (
    ChatPromptTemplate,
)  # to initialize the prompt template
from langchain_core.output_parsers import (
    StrOutputParser,
)  # to parse the output of the llm
...
def retrieval_chain_with_lcel():
    ...
    """
    retrival_chain = RunnablePassthrough.assign(
